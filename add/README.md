...
Two editable whole numbers and an answer field. Check validates the answer; Show answer reveals it; Random generates another small pair. Editing either operand clears stale answers and feedback.
...
Test: http://localhost:8080/plugin-tester.html?plugin=add
...
Regression tests: `node --test add/add.test.cjs`
